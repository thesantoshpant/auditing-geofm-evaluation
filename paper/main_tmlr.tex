...
in 9 of 12 region$\times$model cells under in-region evaluation at $\varepsilon{=}0.02$ AUROC. Kenya is
...
$t$-interval ($df{=}9$) for ten-seed U-Net and FT-Prithvi. FT-Prithvi $=$ fine-tuned Prithvi
...
$n{=}203{,}864$ boundary pixels). The five classifiers evaluated here (four frozen probes $+$ the per-pixel
...
pixels) drops the five classifiers evaluated here (four frozen probes $+$ the
